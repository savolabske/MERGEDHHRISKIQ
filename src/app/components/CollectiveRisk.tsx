                  ...
                  {isAddingNote && (
                    <div className="p-4 border border-border rounded-xl bg-muted">
                      ...
                      <textarea
                        ...
                        className="w-full h-20 px-3 py-2 bg-card border border-border rounded-lg text-sm text-secondary-foreground placeholder:text-text-subtle focus:outline-none focus:border-primary resize-none"
