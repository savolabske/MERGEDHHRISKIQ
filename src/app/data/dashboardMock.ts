...
export const DASHBOARD_METRICS = [
  {
    ...
    sparkline: [22, 24, 26, 25, 28, 30, 32, 34],
  },
  {
    ...
    sparkline: [18, 20, 19, 22, 24, 26, 28, 31],
  },
  {
    id: 'climate-issues',
    label: 'CLIMATE ISSUES',
    value: '42',
    trend: '— stable',
    trendClass: 'text-text-subtle',
    tintFrom: 'var(--warning-subtle)',
    sparklineColor: 'var(--warning)',
    sparkline: [38, 39, 40, 41, 40, 41, 42, 42],
  },
  {
    id: 'programmatic-risks',
    label: 'PROGRAMMATIC RISKS',
    value: '19',
    trend: '▼ 3 closed this month',
    trendClass: 'text-success',
    tintFrom: 'var(--primary-subtle)',
    sparklineColor: 'var(--primary)',
    sparkline: [24, 23, 22, 21, 21, 20, 19, 19],
  },
] as const;
